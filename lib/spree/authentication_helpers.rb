...
# in solidus 3.0.0. You can customize the helper method
...
module Spree
  ...
  module AuthenticationHelpers
    ...
    def spree_login_path
      main_app.vendor_session_path
    end

    def spree_signup_path
      main_app.new_vendor_registration_path
    end

    def spree_logout_path
      main_app.destroy_vendor_session_path
    end
  end
end
